...
export default function Footer() {
    ...
    return (
        <div className='footer'>
            <div className={isTablet ? "container-fluid flex justify-center padding" : "container justify-center flex mx-auto padding"}>
                <FooterLinks/>
            ...
            <div className={isTablet ? "container-fluid flex px py footer-copyright padding" : "container flex mx-auto px py footer-copyright padding"}>
