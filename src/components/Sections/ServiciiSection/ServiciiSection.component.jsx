...
export default function ServiciiSection() {
    ...
    return (
        <div className={isTablet ? 'servicii-section container mx-auto' : 'servicii-section container-fluid mx-auto'}>
            <IntroSection 
                caption={'servicii'} 
                title={'Mesaje terapeutice sau de relaxare'} 
                copy={'Elimina stresul, oboseala si durerile musculare acumalate dupa serviciu sau efort fizic intens.'}
            />
