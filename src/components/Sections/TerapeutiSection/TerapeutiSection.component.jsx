...
export default function TerapeutiSection() {
    ...
    return (
        <div className={isTablet ? 'terapeuti-section container mx-auto' : 'terapeuti-section container-fluid mx-auto'}>
            <IntroSection 
                caption={'terapeuti'} 
                title={'Ai pregatire in domeniul kineto terapiei?'} 
                copy={'Daca ai pregatire in domeniul kineto terapiei te poti alatura echipei KINETIC STUDIO. Contacteaza-ne pe social media sau telefonic!'}
            />
